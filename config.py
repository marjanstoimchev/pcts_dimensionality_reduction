...
class PlanetUasConfig(BaseConfig):
    extension = 'jpg'
    n_classes = 17
    image_size = 256
...
class ConfigSelector(BaseConfig):
    ...
    def select(self, dataset):
        if dataset == 'UCM':
            ...
            config = PlanetUasConfig()
        elif dataset == 'BEN_19_001':
            config = BENConfig19()
        elif dataset == 'BEN_19_full':
            config = BENConfig19()
        elif dataset == 'BEN_43_full':
            config = BENConfig43()           
        elif dataset == 'BEN_19_01':
            config = BENConfig19()
        elif dataset == 'BEN_43_001':
            config = BENConfig43()
        elif dataset == 'BEN_43_01':
            config = BENConfig43()
        return config
    ...
    def ConfigParser(self):
        ...
        parser.add_argument('--percent', type=int, default=10, help='Number of trainable layers')
        ...
        #parser.add_argument('--n_estimators', type=int, default=50, help='Number of estimators')
        #parser.add_argument('--max_features', type=str, default="log2", help='Save path')
